...
namespace Sample.Design
{
    public static class SampleData
    {
        ...
        public static IEnumerable<Template10.Samples.ValidationSample.Models.User> SampleUsers(Validate validator)
        {
            ...
            yield return BuildUser(id++, "Charles 'Trip'", "Tucker III", validator, "invalid_email");
            yield return BuildUser(id++, "Malcolm", "Reed", validator, "invalid_email");
            yield return BuildUser(id++, "Hoshi", "Sato Main", validator, "invalid_email");
        ...
        public static Template10.Samples.ValidationSample.Models.User BuildUser(int id, string first, string last, Validate validator, string email = null)
        {
            var user = new Template10.Samples.ValidationSample.Models.User
            {
                ...
                Email = email ?? $"{first}.{last}@domain.com",
                IsAdmin = id % 3 == 0,
